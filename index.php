    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav ms-auto btn fs-5 register">
          ...
          <li class="nav-item"><a href="./php/login.php" class="nav-link" data-bs-target="">Log In</a></li>
          <li class="nav-item"><a href="./php/create.php" class="nav-link bg-primary text-white" data-bs-target="">Sign
              Up</a> </li>
        </ul>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="hero-text">
            ...
            <a href="" class="btn hero-btn" id="gg">Book Now</a>
          </div>
        </div>
    ...
    <div class="container">
      <div class="service-text">
        ...
        <div class="row row-cols-1 row-cols-md-2 g-4">
          ...
          <div class="col">
            <h4 class="col-sm card-topic text-center">Green Cleaning</h4>
            <div class="card">
            ...
            <div class="carousel-item">
              <div class="content text-center">
                ...
                <p>"Our long standing house keeper moved and I have been trouble finding a reliable replacement so I
                  ...
                  . I will definitely calling them back.
                  Thank you."</p>
